...
import com.small.o2o.comp.core.enums.DataSourcesType;
...
public class DynamicDSContextHolder {
    ...
    public static final Logger log = LoggerFactory.getLogger(DynamicDSContextHolder.class);
    ...
    public static String getDataSourceType() {
        ...
        return  key ==null ? DataSourcesType.DEFAULT.name() : key;
    }
